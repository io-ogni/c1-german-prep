...
export default function GuidePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      {/* Card */}
      <div className="relative overflow-hidden rounded-2xl border border-border bg-card min-h-[420px]">
        <AnimatePresence mode="wait">
          ...
          >
            {/* Header */}
            <div className={cn('inline-flex items-center gap-3 rounded-xl px-5 py-3 mb-6 bg-gradient-to-r', slide.color)}>
              {slide.icon}
              <div>
