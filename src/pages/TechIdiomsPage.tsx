...
// Dynamically import all idiom images
...
export default function TechIdiomsPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Tech-Redewendungen für den Arbeitsalltag</h1>
      ...
      {/* Counter */}
      <p className="text-xs text-muted-foreground">{filtered.length} von 72 Redewendungen</p>
