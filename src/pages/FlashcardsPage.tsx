...
import { ArrowLeft, RotateCcw, SkipForward, Check, X, Eye, Trophy, Flame, Sparkles } from 'lucide-react';
...
export default function FlashcardsPage() {
  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center gap-6 relative">
      {/* Feedback toast */}
      {feedbackMessage && (
        <div
          className={cn(
            "fixed top-20 left-1/2 -translate-x-1/2 z-50 px-6 py-3 rounded-xl text-lg font-bold shadow-lg animate-fade-in",
