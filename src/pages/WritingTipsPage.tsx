          ...
          <Accordion type="multiple" className="w-full">
            ...
            <AccordionItem value="redemittel-einleitung">
              ...
              <AccordionContent className="space-y-5 pt-2">
                <SubSection label="Aktualität herstellen" phrases={[
                ...
                <SubSection label="Ein Problem einleiten" phrases={[
                ...
                <SubSection label="Zum Hauptteil überleiten" phrases={[
            ...
            <AccordionItem value="redemittel-hauptteil">
              ...
              <AccordionContent className="space-y-5 pt-2">
                ...
                <SubSection label="Gegenargumente einleiten" phrases={[
                ...
                <SubSection label="Beispiele anführen" phrases={[
            ...
            <AccordionItem value="redemittel-schluss">
              ...
              <AccordionContent className="space-y-5 pt-2">
                <SubSection label="Fazit ziehen" phrases={[
                  'Zusammenfassend lässt sich feststellen, dass ...',
                  'Nach Abwägung der Vor- und Nachteile lässt sich feststellen, dass ...',
                  'Alles in allem zeigt sich, dass ...',
                ]} />
                <SubSection label="Eigene Meinung" phrases={[
                  'Meiner Ansicht nach ...',
                  'Ich bin der Überzeugung, dass ...',
                ]} />
                <SubSection label="Ausblick" phrases={[
